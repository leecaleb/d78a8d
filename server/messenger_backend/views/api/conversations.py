    ...
    def get(self, request: Request):
        try:
            ...
            conversations = (
                ...
                .prefetch_related(
                    Prefetch("readReceipt", queryset=ConversationUser.objects.all())
                )
                .prefetch_related(
                    Prefetch(
            ...
            for convo in conversations:
                ...
                convo_dict["otherUser"]["lastReadMessageId"] = other_user_read_receipt.lastMessageReadId if other_user_read_receipt else None
                # set property for amount of unread messages
                my_last_read_message_id = my_read_receipt.lastMessageReadId if my_read_receipt else None
